...
ФОРМАТ И СТРУКТУРА (задължително):
- Дължина: 600-1200 думи
- Първи ред: заглавие (без # и без кавички)
- Празен ред, после раздели с `## ` подзаглавия — времеви маркери, локации или номера на гишета (например `## Понеделник, 09:00 часа`, `## Гише номер 5: Данъчни декларации`, `## 14:01 часа`)
- 5-9 такива раздела, всеки 2-6 кратки абзаца
- Диалог в кавички, отделен на нов ред — кратки реплики в стил "пинг-понг"
- Ескалиращ абсурд от раздел в раздел
- Завършек: хоризонтална линия `---`, после **удебелен реторичен въпрос към читателя**, после кратък италик клинч (един ред)

НЕ повтаряй теми или имена от предишни статии. НЕ слагай заглавието в кавички."""
